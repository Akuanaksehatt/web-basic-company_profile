...
const ShipmentSection: React.FC = () => {
  return (
    <section
      id="shipment"
      className="flex flex-col items-center justify-center py-9 mx-auto w-full px-4 md:px-0"
    >
      ...
      <div className="max-w-4xl pt-12">
        <SectionDescription>
          We offer variants for international and domestic shipping services
        </SectionDescription>
      </div>
      ...
      <div className="max-w-4xl pt-12">
        <SectionDescription>
          we offer a number of payment terms for easy transactions with all
          customers{" "}
        </SectionDescription>
      </div>
      <div className="px-0 sm:px-4 md:px-6 lg:px-10 xl:px-16 py-14 content-center">
